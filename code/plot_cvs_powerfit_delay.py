...
ax.plot(x, func_powerlaw(x, *popt0), label='0 s delay fit', color=colors2[2], lw=2, zorder=10)
ax.plot(x, func_powerlaw(x, *popt2), label='2 s delay fit', color=colors2[3], lw=2, zorder=10)

axins = inset_axes(ax, 3, 2.5, loc=1)
plot_errorbars(ms_0, axins, color=colors[1])
plot_errorbars(ms_2, axins, color=colors[3])
axins.plot(x, func_powerlaw(x, *popt0), lw=2, color=colors2[2], zorder=10)
axins.plot(x, func_powerlaw(x, *popt2), lw=2, color=colors2[3], zorder=10)
